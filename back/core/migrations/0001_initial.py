    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data', models.FileField(max_length=255, storage=django.core.files.storage.FileSystemStorage(base_url='/errors/', location='C:\\MIS\\Projects\\PY\\AbbyTrans\\users\\errors'), upload_to='%Y/%m/%d/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regular', models.CharField(max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Translates',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('lang_orig', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='projects', to='core.languages')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=50)),
                ('state', models.SmallIntegerField(choices=[(0, 'deleted'), (1, 'uploaded'), (2, 'parsed'), (3, 'parse error'), (4, 'started'), (5, 'translated')], default=1)),
                ('method', models.CharField(max_length=10)),
                ('options', models.JSONField(null=True)),
                ('data', models.FileField(max_length=255, storage=django.core.files.storage.FileSystemStorage(base_url='/users/', location='C:\\MIS\\Projects\\PY\\AbbyTrans\\users'), upload_to=core.models.user_directory_path)),
                ('md5sum', models.CharField(max_length=32)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ...
                ('repo_founded', models.BooleanField(null=True)),
                ('codec', models.CharField(max_length=20)),
                ('number_top_rows', models.PositiveSmallIntegerField(null=True)),
                ('number_bot_rows', models.PositiveSmallIntegerField(null=True)),
                ('folder', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.folders')),
                ('lang_orig', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='files', to='core.languages')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('translate_to', models.ManyToManyField(related_name='files_m', to='core.Languages')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('checked', models.BooleanField(default=False)),
                ('translate_copy', models.FileField(blank=True, max_length=255, upload_to='')),
