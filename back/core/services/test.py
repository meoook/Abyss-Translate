...
print(base64.b64encode('xckDCgTDkpEAtWnfYe:TTuaxUvCPynXBZd6pMeumDtfuchzdJvp'.encode()).decode())
print(base64.b64encode('55aa8a87265bfa0f5ccf:fa43864806ab46c5fb45f39ee8828d110a4d8b59'.encode()).decode())
# def get_data(token):
